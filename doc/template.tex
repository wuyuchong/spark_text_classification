...
\textsc{\Large 大数据分析分布式计算}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 基于 Spark 的电影评论文本分类}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 指导老师：李丰}\\[0.5cm] % Minor heading such as course title
\end{center}
...
{\large 2022年1月15日}\\[2cm] % Date, change the \today to a set date if you want to be precise
